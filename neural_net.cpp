...
int Pool::runNet( Prey* prey, Wolf *wolf1, int mem, Brain* brain, bool* controls)
{// input pointer to controls array, results array, and member of pool.

	//set values for inputs.
	brain->v_matrix[0][0] = wolf1->getPositionX(); 
	brain->v_matrix[0][1] = wolf1->getPositionY();
	brain->v_matrix[0][2] = prey->getPositionX();
	brain->v_matrix[0][3] = prey->getPositionY();	
